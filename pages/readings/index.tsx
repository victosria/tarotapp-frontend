  ...
  return (
    <div className="mx-auto max-w-5xl px-6 py-16">
      ...
      <div className="flex justify-end mt-8">
        <Link href="/readings/new" className="rounded-full bg-gradient-gold text-cream px-5 py-2.5 text-xs uppercase tracking-widest">+ New reading</Link>
      </div>
            ...
            return (
              <div key={r.id} className="rounded-2xl bg-card border border-[color-mix(in_oklab,var(--gold)_25%,transparent)] p-6 flex flex-col md:flex-row md:items-center gap-4">
                ...
                <div className="flex gap-2 shrink-0">
                  <Link href={`/readings/${r.id}`} className="rounded-full border border-brown/30 px-4 py-2 text-xs uppercase tracking-widest text-brown hover:bg-cream-deep">Open</Link>
